...
const missingCheckoutSchema = new mongoose.Schema({
  ...
  reviewAction: { type: String, enum: ['none', 'approved', 'rejected', 'expired', 'waived_excused', 'unpaid_half', 'unpaid_full'], default: 'none' },
  reviewNote: { type: String, trim: true, maxlength: 500, default: '' },
  finalizedAt: Date,
  conversionReason: { type: String, maxlength: 200, default: '' },
  ...
  compensationDecision: { type: String, enum: ['waive_excused','unpaid_half','unpaid_full', 'waive_no_deduction', 'unpaid'], default: null },
}, { _id: false })
...
const attendanceSchema = new mongoose.Schema({
  ...
  exceptionStatus: { type: String, trim: true, maxlength: 160, default: '' },
  ...
  checkoutType: { type:String, enum:['MANUAL_CHECKOUT','AUTO_CHECKOUT','HR_CORRECTION','HR_OVERRIDE','NONE'], default:null },
  autoCheckout: {
    appliedAt: Date,
  ...
  correctionAudit: [{
    ...
    approvedAt: Date,
    compensation: { type: String, enum: ['waive_excused', 'unpaid_half', 'unpaid_full'], default: null },
