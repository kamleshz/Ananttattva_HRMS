...
const leaveRequestSchema = new mongoose.Schema({
  ...
  dayType: { type: String, enum: ['full_day', 'half_day', 'early_leave'], default: 'full_day', required: true },
  ...
  earlyLeaveMinutes: { type: Number, min: 1, max: 509, default: null },
  hrCompensationDecision: { type: String, enum: ['paid_deduction', 'unpaid', 'waived_no_deduction'], default: null },
  policySnapshot: {
