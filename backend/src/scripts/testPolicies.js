...
assert.deepEqual(allocateMonthlyAllowance(0,800,0),{monthlyLimit:2000,acceptableTravel:800,acceptableAmount:800,nonAcceptableAmount:0})
assert.deepEqual(allocateMonthlyAllowance(1600,800,0),{monthlyLimit:2000,acceptableTravel:400,acceptableAmount:400,nonAcceptableAmount:400})
assert.deepEqual(allocateMonthlyAllowance(1600,689,0),{monthlyLimit:2000,acceptableTravel:400,acceptableAmount:400,nonAcceptableAmount:289})
assert.deepEqual(allocateMonthlyAllowance(2000,500,0),{monthlyLimit:2000,acceptableTravel:0,acceptableAmount:0,nonAcceptableAmount:500})
